...
@Component({
  selector: 'app-human-loss',
  templateUrl: './human-loss.page.html',
  styleUrls: ['../bridges/bridges.page.scss'],
})
export class HumanLossPage implements OnInit {
  taluks_data: any = [];
  districts_data: any = [];
  firkas_data: any = [];
  villages_data: any = [];
  ...
  dateChangeEvent(e) {
    ...
    this.death_date = e.detail.value;
  }
    ...
    this.loadingCtrl
      ...
      .then((loadingEl) => {
        ...
        var params = JSON.stringify({
          extra_param: 'human_loss',
          district_id: this.district_id,
          taluk_id: this.taluk_id,
          firka_id: this.firka_id,
          village_id: this.village_id,
          victim_name: this.victim_name,
          cause_of_death: this.death_cause,
          date_of_death: this.death_date,
