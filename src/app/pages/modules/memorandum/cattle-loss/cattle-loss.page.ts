...
@Component({
  selector: 'app-cattle-loss',
  templateUrl: './cattle-loss.page.html',
  styleUrls: ['../bridges/bridges.page.scss'],
})
export class CattleLossPage implements OnInit {
  taluks_data: any = [];
  districts_data: any = [];
  firkas_data: any = [];
  villages_data: any = [];
  ...
  dateChangeEvent(e) {
    ...
    this.date_of_death = e.detail.value;
  }
    ...
    this.loadingCtrl
      ...
      .then((loadingEl) => {
        ...
        var params = JSON.stringify({
          ...
          count_of_buffalo: this.count_of_buffalo,
          count_of_goat: this.count_of_goat,
          count_of_calf: this.count_of_calf,
          count_of_bullock: this.count_of_bullock,
          count_of_poultry: this.count_of_poultry,
