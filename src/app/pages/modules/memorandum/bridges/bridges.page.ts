...
@Component({
  ...
  templateUrl: './bridges.page.html',
  styleUrls: ['./bridges.page.scss'],
})
export class BridgesPage implements OnInit {
  taluks_data: any = [];
  districts_data: any = [];
  firkas_data: any = [];
  villages_data: any = [];
    ...
    this.loadingCtrl
      ...
      .then((loadingEl) => {
        ...
        var params = JSON.stringify({
          ...
          no_of_bridges: this.no_of_bridges,
          cost_temp: this.cost_temp,
          cost_perm_1: this.cost_perm_1,
          cost_perm_2: this.cost_perm_2,
